...
export const EXERCISE_LIBRARY = [
  ...
  ex('smith_machine_overhead_shoulder_press', 'Smith Machine Overhead Press', 'shoulders', 'machine', 'compound', 180, '8-12', { secondary: ['arms'], source: 'free-exercise-db', license: 'public-domain' }),
